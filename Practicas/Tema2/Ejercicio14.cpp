...
double derivada, n1, n2, n3, n4, n5, media, distancia1, distancia2, distancia3, distancia4,
distancia5;
...
derivada = sqrt((distancia1+distancia2+distancia3+distancia4+distancia5)/n);

cout<<"La derivada es: "<<derivada << endl;
